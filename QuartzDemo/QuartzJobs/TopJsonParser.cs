...
namespace VIM.Data.Common.Parser
{
    ...
    public class TopJsonParser : ITopParser
    {
        ...
        public T Parse<T>(string body) //where T : TopResponse
        {
            ...
            //      MatchCollection matches1 = Regex.Matches(body, "(\\\"(?<key>[^\\\"]+)\\\":\\\"(?<value>[^,\\\"]+)\\\")|(\\\"(?<key>[^\\\"]+)\\\":(?<value>[^,\\\"\\}]+))");
            ...
            //}
            //var matches = Regex.Matches(body, "(\\\"(?<value>[^,\\\"]+)\")|(?<value>[^,\\[\\]]+)");
            ...
            ////Regex.Matches(body, "(\\"(?<value>[^,\\"]+)")|(?<value>[^,\\[\\]]+)");
            //while (reader.Read())
            //{
            //    //Console.WriteLine(reader.TokenType + "\t\t" + reader.ValueType + "\t\t" + reader.Value);
            //    VIM.Logger.LogUtil.LogDebug(reader.TokenType + "\t\t" + reader.ValueType + "\t\t" + reader.Value);
            //}
            return rsp;
        }
